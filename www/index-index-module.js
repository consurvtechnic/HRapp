...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'login',
                loadChildren: () => Promise.all(/*! import() | pages-login-login-module */[__webpack_require__.e("default~approve-modal-approve-modal-module~home-home-module~leave-modal-leave-modal-module~pages-lis~f83bafb5"), __webpack_require__.e("common"), __webpack_require__.e("pages-login-login-module")]).then(__webpack_require__.bind(null, /*! ../pages/login/login.module */ "F4UR")).then(m => m.LoginPageModule)
            },
            {
                path: 'signup',
